...
RUN wget -q -O /tmp/libmediainfo-dev.deb http://ftp.de.debian.org/debian/pool/main/libm/libmediainfo/libmediainfo0v5_23.04+dfsg-1_amd64.deb \
  && dpkg -i /tmp/libmediainfo-dev.deb \
  && rm /tmp/libmediainfo-dev.deb

RUN wget -q -O /tmp/mediainfo.deb https://mediaarea.net/download/binary/mediainfo/23.04/mediainfo-dbg_23.04-1_amd64.xUbuntu_20.04.deb \
